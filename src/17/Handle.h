...
#include <exception>
#include <stdexcept>
/* generic handle class -- provides pointer-like behavior, except
 * access through an unbound Handle throws a runtime_error exception
 * the object to which the Handle points is deleted 
